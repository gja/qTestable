...
#include "handlers/handler_for_mainWindow.h"
//NEXTINCLUDEHERE 
...
IQTestableClassHandler *QTestable::StandardHandlers::mainWindowHandler()
{
  return new handler_for_mainWindow("mainWindow");
}
